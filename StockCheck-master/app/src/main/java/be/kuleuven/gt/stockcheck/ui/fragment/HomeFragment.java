...
public class HomeFragment extends Fragment implements RecyclerViewInterfaceForCategory, RecyclerViewInterface {
    ...
    private void setupRecyclerView() {
        String url = Endpoints.HOME_GET_ITEM.getUrl() + username;
    ...
    private void fetchCategoryItemCounts(final VolleyCallback callback) {
        String url = Endpoints.HOME_GET_CATEGORY_ITEM_COUNTS.getUrl() + username;
        RequestQueue requestQueue = Volley.newRequestQueue(getActivity());
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
                Request.Method.GET,
                url,
